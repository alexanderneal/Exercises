...
struct PilatesList {
    ...
    static let topPilates = [
        Pilates(imageName: "leg_circle", title: "leg_circle", description: "Inhale to prepare. Exhale to float one leg into single table top position. Inhale to hold. Exhale as you circle the leg away in a clockwise direction and inhale as you circle the leg back. Repeat for 30 seconds. Then repeat in an anti-clockwise direction. Repeat on each side"),
        Pilates(imageName: "single_leg_strech", title: "single_leg_strech",description: "lay down with our backs resting on the floor with our legs flexed at an angle of 90º. Lay down with our backs resting on the floor with our legs flexed at an angle of 90º"),
